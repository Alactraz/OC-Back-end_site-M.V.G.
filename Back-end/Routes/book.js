...
router.post('/', auth, upload.single('image'),optimizeImage , bookController.createBook);

// Route pour modifier un livre existant avec image
router.put('/:id', auth, upload.single('image'),optimizeImage , bookController.updateBook);
